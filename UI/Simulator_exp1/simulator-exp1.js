...
function Simulate() {
    ...
    if (Qr < 0) {
        ...
        ans1.innerHTML = "Q is surplus.So Inductive nature of reactive power is required"
    } else if (Qr > 0) {
        ...
        ans1.innerHTML = "No compensation required"
    }
    ...
    //console.log('Acutal voltage at the midd-point without mid-point compensation is', Vm);

    //console.log('Reactive power is required to maintain the mid-point voltage at 1 per unit', Qr);
    ...
    ans2.innerHTML = "Acutal voltage at the midd-point without mid-point compensation is " + Vm.toFixed(4) + ""
    ans3.innerHTML = 'Reactive power is required to maintain the mid-point voltage at 1 per unit'
