...
const data = [
    [{
        title:"Question 1",
        body:"The penalty factor is defined as the ratio of power generated by the plant to the actual power demand of the load being met after transmission loss.",
        answer: {
            option: ["Yes","No"],
            ans:"a"
        }
    ...
    {
        title:"Question 1",
        body:"dCi/dPi+ λ∂PL/∂Pi =λi=1,2,………..,N The above equation is called the 'Power Balance Equation'.  ",
        answer: {
            option:["Yes","No"],
            ans:"b"
        }
    ...
    {
        title:"Question 2",
        body:"Can we reduce transmission losses using bundled conductors?",
        answer: {
            option:["Yes","No"],
            ans:"a"
        }
    ...
    {
        title:"Question 1",
        body:"All generation units  must operate with the same incremental fuel cost.",
        answer: {
            option:["Yes","No"],
            ans:"a"
        }
    ...
    {
        title:"Question 1",
        body:"The idea is to minimize the cost of electricity generation without considering quality and reliability.",
        answer: {
            option:["Yes","No"],
            ans:"b"
        }
