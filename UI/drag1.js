...
const prebuilt_code = "<div id='drop-box'> <span>you can drop the blocks here</span> </div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='mat0'> Matrix <span class='d'>@costdata</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='costdata' type='text' name='Variable' id='mat0$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' class='visually-hidden' for='ROW'>Enter the number of rows of the matrix</label> <input value='3' type='text' name='' id='mat0$ROW' placeholder='Number of Rows'> <br><label class='visually-hidden' for='COL' class='visually-hidden'>Enter the number of rows of the matrix</label> <input value='4' type='text' name='' id='mat0$COL' placeholder='Number of Columns'> <br><button id='' class='btn btn-custom-outline-brown' onclick='matinput(prevSelection[0])'>Generate Table</button> <br><div class='matinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'><input type='text' id='4'><br><br><input type='text' id='5'><input type='text' id='6'><input type='text' id='7'><input type='text' id='8'><br><br><input type='text' id='9'><input type='text' id='10'><input type='text' id='11'><input type='text' id='12'><br><br></div><button id='mat0$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst1'> Constant <span class='d'>@ng</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='ng' type='text' name='Variable' id='cst1$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='costdata.length' type='text' name='' id='cst1$VAL' placeholder='Value'> <br><button id='cst1$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec2'> Vector <span class='d'>@P</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='P' type='text' name='Variable' id='vec2$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='3' type='text' name='' id='vec2$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec2$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst3'> Constant <span class='d'>@sum1</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='sum1' type='text' name='Variable' id='cst3$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst3$VAL' placeholder='Value'> <br><button id='cst3$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for4'> For <span class='d'>@sum1</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for4$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='P.length' type='text' name='' id='for4$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for4$STEP' placeholder='Step (Default 1)'> <br><button id='for4$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva5'> Evaluate <span class='d'>@sum1</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='sum1' type='text' name='Variable' id='eva5$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='sum1+P[i]' type='text' name='' id='eva5$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva5$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst6'> Constant <span class='d'>@Pd</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='Pd' type='text' name='Variable' id='cst6$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='500' type='text' name='' id='cst6$VAL' placeholder='Value'> <br><button id='cst6$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst7'> Constant <span class='d'>@e</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='e' type='text' name='Variable' id='cst7$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='10' type='text' name='' id='cst7$VAL' placeholder='Value'> <br><button id='cst7$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec8'> Vector <span class='d'>@delL</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='delL' type='text' name='Variable' id='vec8$VAR' placeholder=<labVariable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng+1' type='text' name='' id='vec8$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'><input type='text' id='4'></div><button id='vec8$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec9'> Vector <span class='d'>@uno</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='uno' type='text' name='Variable' id='vec9$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng' type='text' name='' id='vec9$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec9$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec10'> Vector <span class='d'>@a</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='a' type='text' name='Variable' id='vec10$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng' type='text' name='' id='vec10$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec10$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec11' draggable='false'> Vector <span class='d'>@b</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='b' type='text' name='Variable' id='vec11$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng' type='text' name='' id='vec11$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec11$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec12' draggable='false'> Vector <span class='d'>@d</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='d' type='text' name='Variable' id='vec12$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng' type='text' name='' id='vec12$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec12$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box ' id='vec13'> Vector <span class='d'>@lamda0</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='lamda0' type='text' name='Variable' id='vec13$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the Number of elements</label> <input value='ng' type='text' name='' id='vec13$VAL' placeholder='Number of elements'> <br><button id='' class='btn btn-custom-outline-brown' onclick='vecinput(prevSelection[0])'>Generate row</button> <br><div class='vecinps'><input type='text' id='1'><input type='text' id='2'><input type='text' id='3'></div><button id='vec13$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst14'> Constant <span class='d'>@lambda</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='lambda' type='text' name='Variable' id='cst14$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst14$VAL' placeholder='Value'> <br><button id='cst14$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for15'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for15$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='ng' type='text' name='' id='for15$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for15$STEP' placeholder='Step (Default 1)'> <br><button id='for15$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva16'> Evaluate <span class='d'>@uno</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='uno[i]' type='text' name='Variable' id='eva16$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='costdata[i][0]' type='text' name='' id='eva16$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva16$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva17'> Evaluate <span class='d'>@a</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='a[i]' type='text' name='Variable' id='eva17$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='costdata[i][1]' type='text' name='' id='eva17$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva17$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva18'> Evaluate <span class='d'>@b</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='b[i]' type='text' name='Variable' id='eva18$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='costdata[i][2]' type='text' name='' id='eva18$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva18$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva19'> Evaluate <span class='d'>@d</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='d[i]' type='text' name='Variable' id='eva19$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='costdata[i][3]' type='text' name='' id='eva19$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva19$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst20'> Constant <span class='d'>@k</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='k' type='text' name='Variable' id='cst20$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='1' type='text' name='' id='cst20$VAL' placeholder='Value'> <br><button id='cst20$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst21'> Constant <span class='d'>@tol</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='tol' type='text' name='Variable' id='cst21$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='3' type='text' name='' id='cst21$VAL' placeholder='Value'> <br><button id='cst21$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst22'> Constant <span class='d'>@itr</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='itr' type='text' name='Variable' id='cst22$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst22$VAL' placeholder='Value'> <br><button id='cst22$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for23'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for23$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='6' type='text' name='' id='for23$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for23$STEP' placeholder='Step (Default 1)'> <br><button id='for23$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for24'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for24$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='ng' type='text' name='' id='for24$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for24$STEP' placeholder='Step (Default 1)'> <br><button id='for24$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva25'> Evaluate <span class='d'>@lamda0</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='lamda0[2]' type='text' name='Variable' id='eva25$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='2 * d[i] * P[i] + b[i]' type='text' name='' id='eva25$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva25$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst26'> Constant <span class='d'>@sum</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='sum' type='text' name='Variable' id='cst26$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst26$VAL' placeholder='Value'> <br><button id='cst26$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst27'> Constant <span class='d'>@count</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='count' type='text' name='Variable' id='cst27$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='lamda0.length' type='text' name='' id='cst27$VAL' placeholder='Value'> <br><button id='cst27$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for28'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for28$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='lamda0.length' type='text' name='' id='for28$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for28$STEP' placeholder='Step (Default 1)'> <br><button id='for28$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva30'> Evaluate <span class='d'>sum</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='sum' type='text' name='Variable' id='eva30$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='sum+lamda0[i]' type='text' name='' id='eva30$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva30$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva31'> Evaluate <span class='d'>@lambda</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='lambda' type='text' name='Variable' id='eva31$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='sum/count' type='text' name='' id='eva31$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva31$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for32'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for32$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='ng' type='text' name='' id='for32$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for32$STEP' placeholder='Step (Default 1)'> <br><button id='for32$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva41'> Evaluate <span class='d'>@delL</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='delL[i]' type='text' name='Variable' id='eva41$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='lamda0[i] - lambda' type='text' name='' id='eva41$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva41$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva33'> Evaluate <span class='d'>@delL</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='delL[ng + 1]' type='text' name='Variable' id='eva33$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='Pd - sum1' type='text' name='' id='eva33$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva33$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='for34'> For <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='START'> Enter the start value of Counter </label> <input value='0' type='text' name='' id='for34$START' placeholder='Start'> <br><label class='visually-hidden' for='END'> Enter the end value of counter </label> <input value='ng' type='text' name='' id='for34$END' placeholder='End'> <br><label class='visually-hidden' for='STEP'> Enter the step value of counter</label> <input value='' type='text' name='' value='' id='for34$STEP' placeholder='Step (Default 1)'> <br><button id='for34$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva42'> Evaluate <span class='d'>@P</span> <div class='details pb-2'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='P[i]' type='text' name='Variable' id='eva42$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='P[i] - (e * delL[i])' type='text' name='' id='eva42$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva42$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst35'> Constant <span class='d'>@balance</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='balance' type='text' name='Variable' id='cst35$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst35$VAL' placeholder='Value'> <br><button id='cst35$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='cst36'> Constant <span class='d'>@tol</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='tol' type='text' name='Variable' id='cst36$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='VAL'>Enter the value</label> <input value='0' type='text' name='' id='cst36$VAL' placeholder='Value'> <br><button id='cst36$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva37'> Evaluate <span class='d'>@balance</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='balance' type='text' name='Variable' id='eva37$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='Pd - sum1' type='text' name='' id='eva37$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva37$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='eva38'> Evaluate <span class='d'>@tol</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' for='VAR'>Enter the variable name</label> <input value='tol' type='text' name='Variable' id='eva38$VAR' placeholder='Variable Name'> <br><label class='visually-hidden' for='EVALUATE'> enter the expression to evaluate </label> <input value='balance' type='text' name='' id='eva38$EVALUATE' placeholder='Evaluate/Math Operations'> <br><button id='eva38$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='opb39'> Print Block <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' class='visually-hidden' for='VAL'>Enter the value to output</label> <input value='' type='text' name='' id='opb39$VAL' placeholder='Enter the message you want to display'> <input value='k' type='text' name='' id='opb39$VAR' placeholder='Value'> <br><button id='opb39$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='opb40'> Print Block <span class='d'></span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' class='visually-hidden' for='VAL'>Enter the value to output</label> <input value='' type='text' name='' id='opb40$VAL' placeholder='Enter the message you want to display'> <input value='p' type='text' name='' id='opb40$VAR' placeholder='Value'> <br><button id='opb40$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div><div class='pl-3 pt-2 noselect selectable bordered-box' id='opb41'> Print Block <span class='d'>@lambda</span> <div class='details pb-2' style='display: none;'> <label class='visually-hidden' class='visually-hidden' for='VAL'>Enter the value to output</label> <input value='' type='text' name='' id='opb41$VAL' placeholder='Enter the message you want to display'> <input value='lambda' type='text' name='' id='opb41$VAR' placeholder='Value'> <br><button id='opb41$OK' class='btn btn-custom-outline-brown' onclick='ok(event)'> Ok </button> </div></div></div>"
