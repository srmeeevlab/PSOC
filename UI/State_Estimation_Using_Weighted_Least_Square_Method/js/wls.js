...
function showdata(){
    ...
    if(datavisible){
        data_disp.innerHTML=""
        data_disp.style.border = "none"
        data_disp.style.overflow = "hidden"
        datavisible = false
        return
    }
    datavisible = true
    ...
    div1.style.marginTop = "2.5rem"
    div1.style.marginBottom = "2.5rem"
    div2.style.marginTop = "2.5rem"
    div2.style.marginBottom = "2.5rem"

    let head1 = document.createElement("h3")
    head1.innerHTML = "Zdata"
    div1.appendChild(head1)
    for (let idx = 0; idx < zdata.length; idx++) {
        let element = document.createElement("p")
        element.innerHTML = `${zdata[idx]}`
    ...
    head2.innerHTML = "Linedata"
    div2.appendChild(head2)
    for (let idx = 0; idx < linedata.length; idx++) {
        let element = document.createElement("p")
        element.innerHTML = `${linedata[idx]}`
        div2.appendChild(element)
        
    }

    data_disp.appendChild(div2)
    data_disp.appendChild(div1)
    data_disp.style.maxHeight = "400px"
    data_disp.style.overflowY = "scroll"
    data_disp.style.border = " 7.5px solid black "
    data_disp.style.marginTop = "1rem"
    data_disp.style.padding = " 1rem"
...
function sim() {
    ...
    head0.innerHTML = " OUTPUT"
    head1.innerHTML = "----- State Estimation ----"
    head2.innerHTML = "| Bus |    V   |  Angle  | "
    head3.innerHTML = "| No  |   pu   |  Degree | "
    head4.innerHTML = '--------------------------';
