...
(function() {
    ...
    const myQuestions = [{
        ...
        {
            question: "The principle of the gradient method is the minimum of a function f(x) can be found by a    series of step that always go in the",
            answers: {
                a: "Upward direction",
        ...
        {
            question: "The following one is used to speed up the convergence of the gradient method",
            answers: {
